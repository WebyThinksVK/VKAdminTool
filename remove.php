...
<?php
	...
	if($err == null){
		...
		echo "<h1><b>!</b> Произошла ошибка при исключении человека (людей) из беседы {$chat_name}. Пожалуйста, повторите заного.<b>!</b><br><b>Инфо об ошибке</b>:<br>Код ошибки - <i>{$kick->error->error_code}</i><br>Сообщение ошибки - <i>{$kick->error->error_msg}</i></h1>" ;
		echo $back;
	}
?>
